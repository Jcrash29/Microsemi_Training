...
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"C:\Future\FPGA\Microsemi\CreativeBoard\IGLOO2\Lab3_part2\synthesis\eSRAM_eNVM_access_top.edn"}
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"C:\Future\FPGA\Microsemi\CreativeBoard\IGLOO2\Lab3_part2\constraint\io\eSRAM_eNVM_access_top.io.pdc"}
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"C:\Future\FPGA\Microsemi\CreativeBoard\IGLOO2\Lab3_part2\constraint\fp\eSRAM_eNVM_access_top.fp.pdc"}
set_compile_info \
    -category {"Options"} \
...
compile \
    ...
    -die PA4MGL2500_N \
    -pkg vf256 \
    -pdc_file {C:\Future\FPGA\Microsemi\CreativeBoard\IGLOO2\Lab3_part2\constraint\io\eSRAM_eNVM_access_top.io.pdc} \
    -pdc_file {C:\Future\FPGA\Microsemi\CreativeBoard\IGLOO2\Lab3_part2\constraint\fp\eSRAM_eNVM_access_top.fp.pdc} \
    -merge_pdc 0
